...
const LoadingAnimation: React.FC = () => (
  <div>
    <svg height="27px" width="27px" viewBox="0 0 128 128" className="loader">
      <defs>
      ...
      <g stroke-dasharray="175.93 351.86" stroke-width="12" stroke-linecap="round">
        <g>
          <rect clip-path="url(#loader-eyes)" height="64" width="128" fill="url(#loader-grad)"></rect>
          <g stroke="url(#loader-grad)" fill="none">
